...
It also provides instant finality where transaction fees can be paid in advance with tokens from different chains thanks to [Irys (formerly Bundlr](https://irys.xyz/).
...
- **Prepaid gas fees**: With [Irys](https://irys.xyz/), developers can cover gas fees upfront.
